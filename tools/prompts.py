...
5. **Не нужно делать очень специфичные таблицы и таблицы с агрегатами**. Нужно только нормализовывать, либо денормализовывать существующие
6. Ответ строго в JSON, никакого текста вне JSON.
7. Каждый DDL должен заканчиваться точкой с запятой.
8. Общий атрибутивный состав таблиц должен сохраниться после изменения структуры базы
